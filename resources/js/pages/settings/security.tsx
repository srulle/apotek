            ...
            {canManageTwoFactor && (
                <div className="space-y-6">
                    <Heading
                        ...
                        description="Kelola pengaturan verifikasi 2 langkah Anda"
                    />
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Anda akan diminta untuk pin aman dan acak selama
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Ketika Anda mengaktifkan verifikasi 2 langkah,
                                Anda akan diminta untuk pin aman selama login.
                                Pin ini dapat diambil dari aplikasi yang
                                mendukung TOTP di ponsel Anda.
                            </p>
